// uw_measurement_api: abstract Frontend / FactorBuilder / provider
// interfaces (platform architecture section 6). Depends on uw_domain and
// uw_sensor_models only — no concrete algorithm, no ROS.
#pragma once
...
// algorithms/factor_builders/* implementation produces one of these; the
// estimator's solver (a hand-rolled Gauss-Newton in v1, see
// algorithms/estimation) evaluates it without knowing which factor type it
