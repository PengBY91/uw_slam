...
// populated from configuration or a submap query; see
// algorithms/factor_builders/sonar_range_factor for the concrete usage and
// its documented v1 limitation (no joint landmark estimation yet).
